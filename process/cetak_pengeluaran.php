...
<body>
    ...
    $query = mysqli_query($con, "SELECT * FROM tb_pengeluaran LEFT JOIN tb_kasir ON tb_kasir.id_kasir = tb_pengeluaran.id_kasir WHERE tanggal >= '$tanggal_awal' AND tanggal <= '$tanggal_akhir' ORDER BY tanggal ASC") or die(mysqli_error($con));
